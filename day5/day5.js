...
alert(`you answer ${point} out of ${len} questions`);
...
for(let item in jobdata.hits){
    console.log('title: '+jobdata.hits[item].jobTitle);
    console.log('salary: '+jobdata.hits[item].jobSalary);
    console.log('location:\n- '+jobdata.hits[item].locations);
    console.log('benefits:');
    for(let iteminben in jobdata.hits[item].benefits){
        console.log('- '+jobdata.hits[item].benefits[iteminben].benefitValue);
    };
    console.log('skills:');
    for(let iteminskill in jobdata.hits[item].skills){
        console.log('- '+jobdata.hits[item].skills[iteminskill]);
    };
    console.log('------------------------------------');
};
...
for(let item in inventory){
    if(!inventoryByBrand[inventory[item].brand.toLocaleLowerCase()]){
        inventoryByBrand[inventory[item].brand.toLocaleLowerCase()] = [];
    };
    inventoryByBrand[inventory[item].brand.toLocaleLowerCase()].push(inventory[item]);
};
